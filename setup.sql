...
('N003', '2025-01-10', '2025-01-10 10:00:00', '財務省', '税制',
 ...
 NULL, 'ニュートラル', '高', '税制改正,贈与税,相続,教育資金'),
...
('N004', '2025-01-08', '2025-01-08 14:30:00', '国税庁', '税制',
 ...
 NULL, 'ニュートラル', '高', '税制改正,相続税,贈与税,事業承継'),
...
-- 追加のニュース（40件）
INSERT INTO NEWS_ARTICLES VALUES
('N011', '2025-01-06', '2025-01-06 09:00:00', 'Reuters', '市況', 'KDDI、5G投資拡大で中期成長見通し引き上げ', 'KDDIは5G関連投資を加速し、2027年度までの中期成長率見通しを引き上げた。法人向けDXサービスも好調で、営業利益率の改善が続く見込み。', 'KDDI中期見通し引き上げ', '9433,KDDI', 'ポジティブ', '中', '通信,5G,DX'),
('N012', '2025-01-05', '2025-01-05 15:00:00', '社内リサーチ', '市況', '三菱商事、資源高で業績好調 - 投資判断「買い」維持', '三菱商事は資源価格の高止まりと非資源分野の成長で業績好調が続く見通し。配当利回りも4%台と魅力的。', '三菱商事業績好調', '8058,三菱商事', 'ポジティブ', '中', '商社,資源,配当'),
('N013', '2025-01-04', '2025-01-04 11:00:00', '日本経済新聞', '市況', '伊藤忠商事、非資源ビジネス拡大で最高益更新へ', '伊藤忠商事は食料・繊維などの非資源分野が好調で、2024年度は純利益の最高益更新が視野に入った。', '伊藤忠最高益へ', '8001,伊藤忠', 'ポジティブ', '中', '商社,非資源'),
('N014', '2025-01-03', '2025-01-03 10:00:00', 'Bloomberg', '為替', '2025年為替見通し：ドル円は150-160円のレンジか', '主要金融機関の2025年為替見通しでは、ドル円は150-160円のレンジで推移するとの予想が多い。日米金利差と日本の経常収支動向が焦点。', '2025年為替見通し', 'USD/JPY', 'ニュートラル', '中', '為替,見通し'),
('N015', '2025-01-02', '2025-01-02 09:00:00', '東京証券取引所', '市況', '2025年大発会、日経平均は小幅上昇でスタート', '2025年最初の取引となった大発会で、日経平均株価は小幅上昇。海外投資家の買いが入り、年初から堅調なスタートとなった。', '大発会小幅上昇', NULL, 'ポジティブ', '低', '日経平均,大発会'),
('N016', '2024-12-28', '2024-12-28 16:00:00', '社内リサーチ', '市況', '【年末特集】2025年注目セクター - 半導体・AI関連', 'リサーチチームは2025年の注目セクターとして半導体・AI関連を挙げた。生成AI需要の拡大でNVIDIA、東京エレクトロンなどに注目。', '2025年注目セクター', '8035,NVDA', 'ポジティブ', '中', '半導体,AI,2025年展望'),
('N017', '2024-12-27', '2024-12-27 14:00:00', '財務省', '税制', '相続税の税務調査強化へ - 海外資産の把握を重点化', '財務省は2025年度から相続税の税務調査を強化する方針。特に海外資産の把握を重点化し、富裕層の申告漏れ対策を進める。', '相続税調査強化', NULL, 'ニュートラル', '中', '相続税,税務調査'),
('N018', '2024-12-26', '2024-12-26 10:00:00', '日本経済新聞', '不動産', '都心オフィス空室率、2%台に低下 - 企業の出社回帰で', '都心5区のオフィス空室率が2%台に低下。コロナ後の出社回帰とAI・DX関連企業の拡大で需要が回復している。', '都心オフィス空室率低下', NULL, 'ポジティブ', '中', '不動産,オフィス'),
('N019', '2024-12-25', '2024-12-25 09:00:00', '内閣府', '経済', 'GDP成長率、2025年は2.0%程度の見通し - 内閣府', '内閣府は2025年度の実質GDP成長率を2.0%程度と予測。インバウンド需要と設備投資の回復が牽引役となる見込み。', 'GDP見通し', NULL, 'ポジティブ', '低', 'GDP,経済成長'),
('N020', '2024-12-24', '2024-12-24 15:00:00', '社内リサーチ', '市況', '日立製作所、DX需要で業績好調 - 目標株価引き上げ', '日立製作所はDXソリューション事業が好調で業績を牽引。リサーチチームは目標株価を4,200円に引き上げ、投資判断「買い」を維持。', '日立目標株価引き上げ', '6501,日立', 'ポジティブ', '中', 'DX,IT'),
('N021', '2024-12-23', '2024-12-23 11:00:00', 'Reuters', '市況', 'ソフトバンクG、AI投資加速で注目高まる', 'ソフトバンクグループはAI分野への投資を加速。Armの業績好調と相まって、株価上昇期待が高まっている。', 'ソフトバンクG AI投資', '9984,SBG', 'ポジティブ', '中', 'AI,投資'),
('N022', '2024-12-22', '2024-12-22 10:00:00', '日本経済新聞', '自動車', 'ホンダ、次世代EV開発に1兆円投資を発表', 'ホンダは2030年までに次世代EV開発に1兆円を投資すると発表。全固体電池の量産化とソフトウェア開発を加速する。', 'ホンダEV投資', '7267,ホンダ', 'ポジティブ', '中', 'EV,自動車'),
('N023', '2024-12-21', '2024-12-21 14:00:00', '社内リサーチ', '市況', 'デンソー、EV関連部品好調で業績上振れ', 'デンソーはEV関連部品の需要増で業績が上振れ。特に熱マネジメント製品が好調で、営業利益率の改善が続く。', 'デンソー業績上振れ', '6902,デンソー', 'ポジティブ', '中', 'EV,自動車部品'),
('N024', '2024-12-20', '2024-12-20 09:00:00', 'Bloomberg', '金融', '米FRB、利下げペース鈍化を示唆 - 12月FOMC', '米FRBは12月のFOMCで政策金利を0.25%引き下げたが、来年の利下げペース鈍化を示唆。ドル高・円安圧力が継続する見通し。', 'FRB利下げ鈍化', NULL, 'ニュートラル', '高', '金融政策,FRB,金利'),
('N025', '2024-12-19', '2024-12-19 15:00:00', '国税庁', '税制', '暦年贈与と相続時精算課税の選択、どちらが有利か - 解説', '2024年税制改正で変更された贈与税制について国税庁が解説資料を公表。暦年贈与と相続時精算課税の選択基準を具体例で示した。', '贈与税制解説', NULL, 'ニュートラル', '中', '贈与税,税制'),
('N026', '2024-12-18', '2024-12-18 11:00:00', '社内リサーチ', '市況', '信越化学、半導体シリコンウェハー需要回復で上方修正期待', '信越化学工業は半導体シリコンウェハーの需要回復で業績上方修正が期待される。投資判断「買い」、目標株価6,500円。', '信越化学上方修正期待', '4063,信越化学', 'ポジティブ', '中', '半導体,素材'),
('N027', '2024-12-17', '2024-12-17 10:00:00', '日本経済新聞', '医薬', '第一三共、がん治療薬が米国で好調 - グローバル展開加速', '第一三共の抗がん剤「エンハーツ」が米国市場で売上好調。パートナーのアストラゼネカとの協業でグローバル展開を加速。', '第一三共がん治療薬好調', '4568,第一三共', 'ポジティブ', '中', '医薬品,がん治療'),
('N028', '2024-12-16', '2024-12-16 14:00:00', '社内リサーチ', '市況', '中外製薬、ロシュとの提携強化で成長加速', '中外製薬は親会社ロシュとの提携を強化し、新薬開発パイプラインを拡充。中長期的な成長が期待される。', '中外製薬成長加速', '4519,中外製薬', 'ポジティブ', '中', '医薬品'),
('N029', '2024-12-15', '2024-12-15 09:00:00', 'Reuters', '不動産', 'Jリート指数、年初来高値更新 - 金利安定で買い安心感', 'Jリート指数が年初来高値を更新。日銀の金利据え置きで金利上昇懸念が後退し、高配当利回りのJリートに買いが入った。', 'Jリート高値更新', '8951,3283', 'ポジティブ', '中', 'REIT,不動産'),
('N030', '2024-12-14', '2024-12-14 16:00:00', '東京証券取引所', '市況', '週間売買代金、過去最高を更新 - 海外マネー流入', '東京証券取引所の週間売買代金が過去最高を更新。海外投資家の日本株買いが活発化し、市場の流動性が向上している。', '売買代金最高', NULL, 'ポジティブ', '中', '株式市場,売買代金');

-- 残り20件
INSERT INTO NEWS_ARTICLES VALUES
('N031', '2024-12-13', '2024-12-13 10:00:00', '日本経済新聞', '経済', '賃上げ率、2025年春闘は5%超の見通し - 経団連', '経団連は2025年春闘の賃上げ率が5%を超える見通しと発表。物価上昇に対応し、実質賃金のプラス転換を目指す。', '賃上げ見通し', NULL, 'ポジティブ', '中', '賃上げ,春闘'),
('N032', '2024-12-12', '2024-12-12 14:00:00', '市況要約', '金融', '証券担保ローン、低金利で利用拡大 - 信託銀行', '信託銀行の証券担保ローンの利用が拡大。低金利環境と株高を背景に、富裕層の資金ニーズに対応している。', '証券担保ローン利用拡大', NULL, 'ポジティブ', '中', 'ローン,信託銀行'),
('N033', '2024-12-11', '2024-12-11 11:00:00', 'Bloomberg', '為替', '円安進行、輸出企業に追い風 - 自動車・電機セクター', '円安進行が輸出企業の業績にプラス。特に自動車・電機セクターでは為替差益の拡大が期待される。', '円安輸出企業追い風', '7203,6758', 'ポジティブ', '中', '為替,輸出'),
('N034', '2024-12-10', '2024-12-10 09:00:00', '日本経済新聞', '金融', 'NISA口座、2024年は過去最高の開設数に', '2024年のNISA口座開設数が過去最高を更新。新NISA制度への移行で投資初心者の参入が加速している。', 'NISA開設最高', NULL, 'ポジティブ', '低', 'NISA,投資'),
('N035', '2024-12-09', '2024-12-09 15:00:00', '社内リサーチ', '市況', '【投資戦略】インフレ環境下での資産配分', 'リサーチチームはインフレ環境下での推奨資産配分を公表。株式50%、債券30%、オルタナティブ20%のポートフォリオを提案。', '資産配分戦略', NULL, 'ニュートラル', '中', '投資戦略,資産配分'),
('N036', '2024-12-08', '2024-12-08 10:00:00', '内閣府', '経済', '景気動向指数、3ヶ月連続で改善 - 内閣府発表', '内閣府発表の景気動向指数は3ヶ月連続で改善。設備投資と個人消費の回復が寄与している。', '景気改善', NULL, 'ポジティブ', '低', '景気,経済指標'),
('N037', '2024-12-07', '2024-12-07 14:00:00', '国税庁', '税制', '事業承継税制の特例措置、2027年末まで延長へ', '事業承継税制の特例措置が2027年末まで延長される見通し。中小企業オーナーの世代交代を後押しする狙い。', '事業承継税制延長', NULL, 'ポジティブ', '中', '事業承継,税制'),
('N038', '2024-12-06', '2024-12-06 11:00:00', '日本経済新聞', '不動産', '軽井沢・箱根など別荘地、富裕層需要で価格上昇', 'リゾート地の別荘需要が増加。テレワーク定着と富裕層の多拠点生活志向で、軽井沢・箱根などの価格が上昇している。', '別荘地価格上昇', NULL, 'ポジティブ', '低', '不動産,別荘'),
('N039', '2024-12-05', '2024-12-05 09:00:00', 'Reuters', '商品', '金価格、過去最高値を更新 - 地政学リスクで買い', '金価格が過去最高値を更新。中東情勢の緊迫化と中央銀行の買い増しで、安全資産としての需要が高まっている。', '金価格最高値', NULL, 'ポジティブ', '中', '金,コモディティ'),
('N040', '2024-12-04', '2024-12-04 15:00:00', '社内リサーチ', '市況', 'Apple、新型iPhone好調で株価上昇', 'AppleのiPhone16シリーズが世界的に好調な売上を記録。AI機能の強化が評価され、株価は年初来高値を更新した。', 'Apple株価上昇', 'AAPL,Apple', 'ポジティブ', '中', 'テック,Apple'),
('N041', '2024-12-03', '2024-12-03 10:00:00', 'Bloomberg', '市況', 'Microsoft、AI事業拡大でクラウド収益増', 'Microsoftのクラウド事業Azureが好調。AI機能の強化で企業向け需要が拡大し、収益成長が加速している。', 'Microsoft AI事業拡大', 'MSFT,Microsoft', 'ポジティブ', '中', 'テック,AI,クラウド'),
('N042', '2024-12-02', '2024-12-02 14:00:00', '社内リサーチ', '市況', 'NVIDIA、データセンター需要で売上倍増', 'NVIDIAのデータセンター向けGPU売上が前年比倍増。生成AI需要の爆発的成長で供給が追いつかない状況が続く。', 'NVIDIA売上倍増', 'NVDA,NVIDIA', 'ポジティブ', '高', 'AI,半導体'),
('N043', '2024-12-01', '2024-12-01 11:00:00', '日本経済新聞', '金融', 'プライベートバンク、富裕層向けサービス拡充競争', '大手証券・銀行がプライベートバンク事業を強化。相続対策や資産運用の高度化ニーズに対応したサービス拡充が進む。', 'PB事業拡充', NULL, 'ニュートラル', '低', 'プライベートバンク,富裕層'),
('N044', '2024-11-30', '2024-11-30 09:00:00', '財務省', '税制', '海外財産調書の提出義務、5000万円超に引き下げ検討', '財務省は海外財産調書の提出義務基準を現行の5000万円超から引き下げることを検討。富裕層の海外資産把握を強化する狙い。', '海外財産調書基準変更', NULL, 'ニュートラル', '中', '税制,海外資産'),
('N045', '2024-11-29', '2024-11-29 15:00:00', '社内リサーチ', '市況', '年末ラリー期待高まる - 日経平均4万2000円視野', 'リサーチチームは年末の株高を予想。海外投資家の買いと国内企業の好業績を背景に、日経平均4万2000円も視野に入ると分析。', '年末ラリー期待', NULL, 'ポジティブ', '中', '株式市場,年末'),
('N046', '2024-11-28', '2024-11-28 10:00:00', '日本経済新聞', '経済', 'インバウンド消費、2024年は過去最高の8兆円見込み', '訪日外国人の消費額が2024年は過去最高の8兆円に達する見込み。円安とアジア富裕層の来日増加が寄与。', 'インバウンド消費最高', NULL, 'ポジティブ', '中', 'インバウンド,消費'),
('N047', '2024-11-27', '2024-11-27 14:00:00', 'Reuters', '為替', '円相場、年末にかけて円安継続か - アナリスト見通し', '主要アナリストの見通しでは、年末にかけて円安基調が継続する見込み。日米金利差と貿易収支の赤字が円安圧力に。', '円安継続見通し', 'USD/JPY', 'ニュートラル', '中', '為替,円安'),
('N048', '2024-11-26', '2024-11-26 11:00:00', '市況要約', '信託', '遺言信託利用、前年比20%増 - 相続対策ニーズ高まる', '信託銀行の遺言信託利用が前年比20%増。高齢化と相続税の課税強化を背景に、相続対策へのニーズが高まっている。', '遺言信託利用増', NULL, 'ポジティブ', '中', '遺言信託,相続'),
('N049', '2024-11-25', '2024-11-25 09:00:00', '日本経済新聞', '経済', 'シニア世代の資産活用、「終活」から「活活」へ', '高齢者の資産活用意識が変化。「死ぬまでに使い切る」から「健康なうちに楽しむ」志向へシフトしている。', 'シニア資産活用', NULL, 'ニュートラル', '低', 'シニア,資産活用'),
('N050', '2024-11-24', '2024-11-24 15:00:00', '社内リサーチ', '市況', '配当利回り4%超銘柄、投資妙味高まる', '高配当株への注目が高まる。配当利回り4%超の銘柄は金利環境を考慮しても魅力的で、長期投資家に人気。', '高配当株注目', '8058,8001', 'ポジティブ', '中', '配当,投資戦略');
...
RELATIONSHIPS (
    ...
    CUSTOMERS_TO_INHERITANCE_TAX AS CUSTOMERS (CUSTOMER_ID) REFERENCES INHERITANCE_TAX
)
